...
{
    public class ModelImportPanel : AImporterPanel<ModelAssetRule>
    {
        ...
        private ModelStyles m_style;

        private ModelStyles styles
        {
            get
            {
                if (m_style == null)
                    m_style = new ModelStyles();
                return m_style;
            }
        }
        ...
        public override void OnInit()
        {
            ...
            string[] folders = ImportPreferences.ImporterSettings.ModelFolders;
        ...
        /// inspector panel
        /// </summary>
        public override void OnRuleGUI(ModelAssetRule assetRule)
        {
...
//                   styles.GenerateAnimation, EditorStyles.foldout);
        ...
        private void ModelPageGUI(ModelAssetRule assetRule)
        {

        }

        private void CommomUI(ModelAssetRule assetRule)
        {
        ...
        private void NormalsAndTangentsGUI(ModelAssetRule rule)
        {
...
//                }
        ...
        private void MaterialsGUI(ModelAssetRule rule)
        {
